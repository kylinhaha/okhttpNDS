...
public final class Cache implements Closeable, Flushable {
    ...
    /**
     * Initialize the cache. This will include reading the journal files from the storage and
     * building
            ...
            public boolean hasNext() {
                ...
                while (delegate.hasNext()) {
                    ...
                    try {
                        ...
                        // We couldn't read the metadata for this snapshot; possibly because the
                        // host filesystem
    ...
    private static final class Entry {
         ...
         */
        private static final String RECEIVED_MILLIS = Platform.get().getPrefix() +
                "-Received-Millis";
         ...
         *   TLSv1.2
         * }</pre>
         * The file is newline separated. The first two lines are the URL and the request method.
         * Next
         * is the number of HTTP Vary request header lines, followed by those lines.
         * <p>
         * <p>Next is the response status line, followed by the number of HTTP response header
         * lines,
         * followed by those lines.
         * <p>
         * <p>HTTPS responses also contain SSL session information. This begins with a blank
         * line, and
         * then a line containing the cipher suite. Next is the length of the peer certificate
         * chain.
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            if (isHttps()) {
                ...
                // The handshake’s TLS version is null on HttpsURLConnection and on older cached
                // responses.
