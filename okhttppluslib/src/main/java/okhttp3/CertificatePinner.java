...
public final class CertificatePinner {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CertificatePinner
                && (equal(certificateChainCleaner, ((CertificatePinner) other)
    ...
    static final class Pin {
        ...
        Pin(String pattern, String pin) {
            ...
            if (pin.startsWith("sha1/")) {
                ...
                throw new IllegalArgumentException("pins must start with 'sha256/' or 'sha1/': "
                        + pin);
            }
    ...
    public static final class Builder {
         ...
         *                Public Key
         *                Info, base64-encoded and prefixed with either {@code sha256/} or {@code
         *                sha1/}.
         */
