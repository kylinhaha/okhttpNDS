...
public final class Response implements Closeable {
     ...
     * body. If fewer than {@code byteCount} bytes are in the response body, the full response
     * body is
    ...
    /**
     * Returns the authorization challenges appropriate for this response's code. If the response
     * code
     ...
     * transmitted the initiating request over the network. If this response is being served from
     * the
