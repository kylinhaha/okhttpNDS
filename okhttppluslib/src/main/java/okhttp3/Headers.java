...
public final class Headers {
    ...
    /**
     * Returns the last value corresponding to the specified field parsed as an HTTP date, or
     * null if
    ...
    /**
     * Returns true if {@code other} is a {@code Headers} object with the same headers, with the
     * same
     ...
     * }</pre>
     * <p>
     * Applications that require semantically equal headers should convert them into a canonical
     * form
    ...
    public static final class Builder {
        ...
        /**
         * Set a field with the specified value. If the field is not found, it is added. If the
         * field is
