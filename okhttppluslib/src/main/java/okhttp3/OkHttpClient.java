...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    static {
        Internal.instance = new Internal() {
            ...
            @Override
            public void apply(ConnectionSpec tlsConfiguration, SSLSocket sslSocket, boolean
                    isFallback) {
    ...
    /**
     * Returns an immutable list of interceptors that observe the full span of each call: from
     * before
     * the connection is established (if any) until after the response source is selected (either
     * the
     ...
     * These interceptors must call {@link Interceptor.Chain#proceed} exactly once: it is an
     * error for
    ...
    public static final class Builder {
         ...
         * automatically send web socket ping frames until either the web socket fails or it is
         * closed.
         * This keeps the connection alive and may detect connectivity failures early. No
         * timeouts are
         ...
         * (which
         * it is by default). To disable proxy use completely, call {@code setProxy(Proxy
         * .NO_PROXY)}.
         */
         ...
         * explicitly. The proxy selector may return multiple proxies; in that case they will be
         * tried
         * in sequence until a successful connection is established.
         * <p>
         * <p>If unset, the {@link ProxySelector#getDefault() system-wide default} proxy selector
         * will
         * be used.
         */
         ...
         * {@link
         * SocketFactory#createSocket() createSocket()} method to create unconnected sockets.
         * Overriding
         * this method, e. g., allows the socket to be bound to a specific local address.
         * <p>
         * <p>If unset, the {@link SocketFactory#getDefault() system-wide default} socket factory
         * will
         * be used.
         */
        ...
        /**
         * Sets the socket factory used to secure HTTPS connections. If unset, the system default
         * will
         * be used.
         *
         * @deprecated {@code SSLSocketFactory} does not expose its {@link X509TrustManager},
         * which is
         ...
         * <p>
         * <p>Most applications should not call this method, and instead use the system defaults.
         * Those
         * classes include special optimizations that can be lost if the implementations are
         * decorated.
         * <p>
         * <p>If necessary, you can create and configure the defaults yourself with the following
         * code:
         * <p>
         * <pre>   {@code
         *
        ...
        /**
         * Sets the certificate pinner that constrains which certificates are trusted. By default
         * HTTPS
         ...
         * </ul>
         * <p>
         * Set this to false to avoid retrying requests when doing so is destructive. In this
         * case the
        ...
        /**
         * Sets the dispatcher used to set policy and execute asynchronous requests. Must not be
         * null.
         */
        ...
        /**
         * Configure the protocols used by this client to communicate with remote servers. By
         * default
         * this client will prefer the most efficient transport available, falling back to more
         * ubiquitous protocols. Applications should only call this method to avoid specific
         * compatibility problems, such as web servers that behave incorrectly when HTTP/2 is
         * enabled.
         * <p>
         ...
         * </ul>
         * <p>
         * <p><strong>This is an evolving set.</strong> Future releases include support for
         * transitional
