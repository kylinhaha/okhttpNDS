...
final class Relay {
    ...
    /**
     * The most recently read bytes from {@link #upstream}. This is a suffix of {@link #file}.
     * Guarded
     * by this.
     */
    ...
    /**
     * Creates a new relay that reads a live stream from {@code upstream}, using {@code file} to
     * share
     * that data with other sources.
     * <p>
     * <p><strong>Warning:</strong> callers to this method must immediately call
     * {@link #newSource} to
     * create a source and close that when they're done. Otherwise a handle to {@code file} will be
     * leaked.
     */
    public static Relay edit(
            File file, Source upstream, ByteString metadata, long bufferMaxSize) throws
            IOException {
    ...
    class RelaySource implements Source {
         ...
         * upstream and copy them to both the file and to the buffer. Finally we release the
         * upstream
