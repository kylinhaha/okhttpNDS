...
public final class HttpHeaders {
    ...
    /**
     * Returns true if none of the Vary headers have changed between {@code cachedRequest} and
     * {@code
     * newRequest}.
     */
     ...
     * from
     * {@code characters}. Returns the input length if none of the requested characters can be
     * found.
     */
