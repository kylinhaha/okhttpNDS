...
public final class Http1Codec implements HttpCodec {
     ...
     * <p>
     * <p>For non-streaming requests with a body, headers must be prepared <strong>after</strong>
     * the
    ...
    /**
     * Sets the delegate of {@code timeout} to {@link Timeout#NONE} and resets its underlying
     * timeout
    ...
    private abstract class AbstractSource implements Source {
        ...
        /**
         * Closes the cache entry and makes the socket available for reuse. This should be
         * invoked when
    ...
    private class FixedLengthSource extends AbstractSource {
        ...
        public void close() throws IOException {
            ...
            if (bytesRemaining != 0 && !Util.discard(this, DISCARD_STREAM_TIMEOUT_MILLIS,
                    MILLISECONDS)) {
                endOfInput(false);
            }
