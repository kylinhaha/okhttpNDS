...
class AndroidPlatform extends Platform {
    ...
    public AndroidPlatform(Class<?> sslParametersClass, OptionalMethod<Socket> setUseSessionTickets,
                           OptionalMethod<Socket> setHostname, OptionalMethod<Socket>
    ...
    public static Platform buildIfSupported() {
        ...
        try {
            ...
            try {
                ...
                getAlpnSelectedProtocol = new OptionalMethod<>(byte[].class,
                        "getAlpnSelectedProtocol");
    ...
    /**
     * X509TrustManagerExtensions was added to Android in API 17 (Android 4.2, released in late
     * 2012).
    ...
    static final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
        ...
        AndroidCertificateChainCleaner(Object x509TrustManagerExtensions, Method
                checkServerTrusted) {
        ...
        public List<Certificate> clean(List<Certificate> chain, String hostname)
            ...
            try {
                ...
                SSLPeerUnverifiedException exception = new SSLPeerUnverifiedException(e
                        .getMessage());
     ...
     * combination with android.os.StrictMode to report on leaked java.io.Closeable's. Available
     * since
     * Android API 11.
     */
