...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
     ...
     * constructed.
     * This is unexpected unless the trust root index in this class has a different trust manager
     * than
    ...
    public List<Certificate> clean(List<Certificate> chain, String hostname)
        ...
        for (int c = 0; c < MAX_SIGNERS; c++) {
            ...
            // If this cert has been signed by a trusted cert, use that. Add the trusted
            // certificate to
            ...
            // Search for the certificate in the chain that signed this certificate. This is
            // typically
