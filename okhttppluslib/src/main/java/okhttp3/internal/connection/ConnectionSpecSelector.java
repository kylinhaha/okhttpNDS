...
public final class ConnectionSpecSelector {
    ...
    /**
     * Configures the supplied {@link SSLSocket} to connect to the specified host using an
     * appropriate
    ...
    public ConnectionSpec configureSecureSocket(SSLSocket sslSocket) throws IOException {
        ...
        if (tlsConfiguration == null) {
            // This may be the first time a connection has been attempted and the socket does not
            // support
            ...
            throw new UnknownServiceException(
                    "Unable to find acceptable protocols. isFallback=" + isFallback
                            ...
                            + ", supported protocols=" + Arrays.toString(sslSocket
                            .getEnabledProtocols()));
        }
    ...
    public boolean connectionFailed(IOException e) {
        ...
        // On Android, SSLProtocolExceptions can be caused by TLS_FALLBACK_SCSV failures, which
        // means we
