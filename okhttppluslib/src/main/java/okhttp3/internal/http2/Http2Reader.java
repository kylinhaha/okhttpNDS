...
final class Http2Reader implements Closeable {
    ...
    public void readConnectionPreface(Handler handler) throws IOException {
        if (client) {
            ...
            if (!CONNECTION_PREFACE.equals(connectionPreface)) {
                throw ioException("Expected a connection header but was %s", connectionPreface
                        .utf8());
            }
        }
    }
    ...
    interface Handler {
        ...
        /**
         * Read a connection-level ping from the peer. {@code ack} indicates this is a reply. The
         * data
        ...
        /**
         * The peer tells us to stop creating streams.  It is safe to replay streams with {@code
         * ID >
         ...
         *
         * @param lastGoodStreamId the last stream ID the peer processed before sending this
         *                         message. If
        ...
        /**
         * HTTP/2 only. Receive a push promise header block. <p> A push promise contains all the
         * headers
         * that pertain to a server-initiated request, and a {@code promisedStreamId} to which
         * response
         * frames will be delivered. Push promise frames are sent as a part of the response to
         * {@code
         * streamId}.
         *
        ...
        /**
         * HTTP/2 only. Expresses that resources for the connection or a client- initiated stream
         * are
         ...
         *
         * @param streamId when a client-initiated stream ID (odd number), the origin of this
         *                 alternate
         *                 service is the origin of the stream. When zero, the origin is
         *                 specified in
         *                 the {@code origin}
         *                 parameter.
         * @param origin   when present, the
         *                 <a href="http://tools.ietf.org/html/rfc6454">origin</a> is
         *                 typically represented as a combination of scheme, host and port. When
         *                 empty, the origin is
