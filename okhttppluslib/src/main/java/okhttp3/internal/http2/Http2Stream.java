...
public final class Http2Stream {
    ...
    /**
     * Count of bytes that can be written on the stream before receiving a window update. Even if
     * this
     ...
     * </ul>
     * <p>
     * <p>Note that the input stream may continue to yield data even after a stream reports
     * itself as
    ...
    /**
     * Removes and returns the stream's received response headers, blocking if necessary until
     * headers
     * have been received. If the returned list contains multiple blocks of headers the blocks
     * will be
     * delimited by 'null'.
     */
    ...
    private final class FramingSource implements Source {
        ...
        /**
         * True if either side has cleanly shut down this stream. We will receive no more bytes
         * beyond
        ...
        void receive(BufferedSource in, long byteCount) throws IOException {
            ...
            while (byteCount > 0) {
                ...
                // If the peer sends more data than we can handle, discard it and close the
                // connection.
                if (flowControlError) {
                    in.skip(byteCount);
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean outFinished) throws IOException {
            ...
            synchronized (Http2Stream.this) {
                writeTimeout.enter();
                try {
                    while (bytesLeftInWriteWindow <= 0 && !finished && !closed && errorCode ==
                            null) {
