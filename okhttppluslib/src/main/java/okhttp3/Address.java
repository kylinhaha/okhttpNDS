...
public final class Address {
    ...
    public Address(String uriHost, int uriPort, Dns dns, SocketFactory socketFactory,
                   ...
                   CertificatePinner certificatePinner, Authenticator proxyAuthenticator, Proxy
                           proxy,
    ...
    /**
     * Returns a URL with the hostname and port of the origin server. The path, query, and
     * fragment of
